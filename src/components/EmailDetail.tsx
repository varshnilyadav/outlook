...
export const EmailDetail: React.FC = () => {
  ...
  if (isThreaded) {
    ...
    return (
      <div className="absolute inset-0 bg-white z-20 flex flex-col animate-in slide-in-from-right duration-200 h-full text-[#202124]">
        {/* Top Bar */}
        <div className="flex items-center justify-between px-4 py-3 bg-white pt-[max(env(safe-area-inset-top),16px)]">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-[18px] font-medium text-[#202124] leading-tight ml-2">
              {email.subject}
            </h1>
          </div>
        </div>
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto no-scrollbar pb-[140px] bg-white">
          ...
          {threadBlocks.map((msg, idx) => {
            ...
            <React.Fragment key={idx}>
              {idx > 0 && (
                <div className="flex items-center px-4 py-2 bg-[#F3F4F6] text-[#6B6B6B] text-sm border-y border-[#E8E8E8] mt-2 mb-2">
              ...
              <div className="px-5 py-4">
                  ...
                  {!isExpanded ? (
                    ...
                    <div className="flex gap-3 w-full justify-between items-center">
                      <div className="flex gap-3 items-center">
                        {msg.name === email.senderName && email.avatarUrl ? (
                          ...
                          <div className={clsx(
                            ...
                            idx === 0 ? "bg-[#DCEEFF] text-[#0f62a6]" : "bg-gray-200 text-[#6B6B6B]"
                          )}>
                            {idx === 0 && <span className="absolute w-11 h-11 rounded-full border border-[#0f62a6] opacity-10"></span>}
                        ...
                        <div>
                          ...
                          <div className="text-[14px] text-[#6B6B6B] flex items-center gap-1 mt-0.5">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        ...
                        <button className="text-[#6B6B6B] p-1 -mr-2">
                    ...
                    <div className="flex gap-3 w-full">
                      ...
                      <div className="flex-1 relative">
                        <div className="flex justify-between items-start">
                          <div className="text-[16px] font-medium text-[#1478C9] pr-8">
                            {msg.name}
                          </div>
                          <button className="text-[#6B6B6B] p-1 absolute top-[-4px] right-[-8px]">
                            <MoreVertical size={20} />
                          </button>
                        </div>
                        ...
                        <div className="grid grid-cols-[auto_1fr] gap-x-2 gap-y-1 mb-2 text-[14px]">
                          <div className="text-[#202124]">To</div>
                        ...
                        {idx === 0 && (
                           <div className="absolute -bottom-1 -right-2 p-1.5 bg-[#F3F4F6] rounded-full text-[#6B6B6B]">
                             <Smile size={16} />
                           </div>
                        )}
                      </div>
                ...
                <div className="text-[16px] text-[#202124] leading-relaxed whitespace-pre-wrap mt-2">
                  {msg.bodyContent}
                </div>
              </div>
            </React.Fragment>
          ...
          <div className="px-5 py-4 text-[#6B6B6B] flex items-center gap-2 mt-4">
        ...
        {/* Bottom Action Bar */}
        <div className="absolute bottom-0 left-0 right-0 bg-white pb-[env(safe-area-inset-bottom)] border-t border-[#E8E8E8] z-10 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
          
          {/* Quick Replies */}
          <div className="flex gap-2 px-4 py-3 overflow-x-auto no-scrollbar border-b border-[#E8E8E8]">
            <button className="whitespace-nowrap px-4 py-2 bg-[#F3F4F6] text-[#202124] rounded-full text-sm font-medium border border-[#E8E8E8]">
          ...
          <div className="flex justify-between items-center px-4 py-3">
            <button className="flex items-center gap-1 text-[#202124] hover:bg-gray-100 px-3 py-1.5 rounded-lg">
